...
class Sim:
    ...
    **Main variables to coordinate with algorithm:**
    ...
    def run(self, until,test_initial_deploy=False,show_progress_monitor=True,mobile_behaviour=False):
        ...
        Tau: adding behavior
        """
        # YOUR TODO: add consumer module behavior here
        # e.g.: self.consumer_module_behavior["SSMS"]["Computation"] = self.basic_behavior
    ...
    def get_pipes_of_node(self, app_name, module, topo_id):
        pipes = []
        for des in self.alloc_module[app_name][module]:
